...
@Service
public class S3BoardImgUploaderService {
    ...
    public List<BoardImgDTO> upload(String fileType, List<MultipartFile> multipartFiles) throws IOException {
        List<BoardImgDTO> s3files = new ArrayList<>();
