package com.example.shoppingmall.global.repository.support;
...
public abstract class QuerydslRepositorySupport {
    ...
    public void setEntityManager(EntityManager entityManager) {
        Assert.notNull(entityManager, "엔티티 매니저는 null이면 안됩니다.");
    ...
    protected <T> Page<T> applyPagination(Pageable pageable,
        ...
        JPAQuery<Long> countQuery = contentQuery.apply(getJpaQueryFactory());
    ...
    protected <T> Page<T> applyPagination(Pageable pageable,
        ...
        // 3. countQuery를 통하여 전체 레코드 수를 가져옴
        JPAQuery<Long> countResult = countQuery.apply(getJpaQueryFactory());
